...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { href: "/dashboard/usermanagement", icon: Users, label: "Student Management" },
    { href: "/dashboard/managecompanies", icon: Mail, label: "Manage Companies" },
  ];
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:sticky top-0 inset-y-0 left-0 z-50 w-[270] bg-white border-r border-slate-200 text-slate-700 flex flex-col h-screen transition-transform duration-300 ease-in-out shrink-0 ${
      ...
      >
        ...
        <div className="p-4 border-t border-slate-200 bg-white shrink-0">
          <button 
            ...
            className="w-full flex items-center gap-3.5 px-4 py-3 rounded-2xl text-sm font-medium text-slate-600 hover:text-red-600 hover:bg-red-50 border border-transparent hover:border-red-200 transition-all duration-200 group cursor-pointer"
          >
